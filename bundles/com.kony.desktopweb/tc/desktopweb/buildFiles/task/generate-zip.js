...
function copyToNoCache(props) {
    ...
    promises = [];
    promises.push(copyFiles(webAppsLoc+'/temp/kony.manifest', tempLoc+'/nocache/desktopweb/kony.manifest'));
    ...
    if(fs.existsSync(loc.ipProjectLocationPath(props)+'/_nocache')) {
        promises.push(copyFiles(loc.ipProjectLocationPath(props)+'/_nocache', tempLoc+'/nocache', {pathName:['kony.manifest']}, null));
    }
