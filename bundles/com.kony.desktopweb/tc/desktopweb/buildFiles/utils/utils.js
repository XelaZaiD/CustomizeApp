...
utils.createProjectProperties = function(filePath) {
    return new Promise(async function(resolve, reject) {
        try {
            ...
            let projProp = {
                //'konywebstudioLoc' : buildProp.konywebstudioLoc,
                ...
                'enableWindowsRuntimeForWebApp': (buildProp["enableWindowsRuntimeForWebApp"] === 'true'),
                'enableWindowsOfflineObjectsForWebApp': (buildProp["enableWindowsOfflineObjectsForWebApp"] === 'true'),
                'es5build': (buildProp["es5build"] === 'true'),
                'fontsFolder': buildProp["desktopweb.fonts.folder"],
