...
(function() {
        ...
        {keey:'Calendar', value:{}, items:[
            {keey:'cancelSelection', value:function(evt) {
                ...
                if(months) {
                    ...
                    _unSelectMonthYearCell(selectedMonth);
                }
                if(years) {
                    selectedYear = $KD.find(years, '[class="'+ skinInfo.selectedValue +'"]')[0];
                    _unSelectMonthYearCell(selectedYear);
                }
            ...
            {keey:'correctSelection', value:function(evt) {
                var $K = kony.$kwebfw$, $KD = $K.dom,  _ = this._kwebfw_,
                    picker = _.picker, selectedMonth, selectedYear,
            ...
            {keey:'onPrevYearSetClick', value:function(evt) {
                var $K = kony.$kwebfw$, $KD = $K.dom, picker = this._kwebfw_.picker,
                monthYearPicker = $KD.find(picker, '[kr="monthYearPicker"]')[0],
                title = $KD.find(monthYearPicker, '[kr="title"]')[0],
                ...
                picker && $KD.focus(picker);
                selectedDiv = $KD.find(monthYearPicker, '[year="'+year+'"]')[0];

                _selectMonthYearCell(selectedDiv);
            ...
            {keey:'onYearClick', value:function(evt) {
                ...
                if(years) {
                    ...
                    _unSelectMonthYearCell(prevCell);
                }

                _selectMonthYearCell(yearCell);
            ...
            {keey:'onMonthClick', value:function(evt) {
                ...
                _selectMonthYearCell(MonthCell);
    ...
    var _showMonthYearPicker = function() {
        var $K = kony.$kwebfw$, $KD = $K.dom, labelCell,
            _ = this._kwebfw_, picker = _.picker, cal, py, cy,
            dm = _.displayedMonths[0], yearBlock = null,selectedMonth = null,
            selectedYear = null,
            monthYearPicker = $KD.find(picker, '[kr="monthYearPicker"]')[0],
        ...
        selectedMonth = $KD.find(monthYearPicker, '[month="'+month+'"]')[0];
        selectedYear = $KD.find(monthYearPicker, '[year="'+year+'"]')[0];

        _selectMonthYearCell(selectedMonth);
        _selectMonthYearCell(selectedYear);

        $KD.html(title, ((month || '') + ' ' + (year || '')));
    };

    var _selectMonthYearCell = function Calendar$_selectMonthYearCell(selectedDiv) {
        var $K = kony.$kwebfw$, $KD = $K.dom, currentSkinInfo;
    ...
    var _unSelectMonthYearCell = function Calendar$_unSelectMonthYearCell(selectedCell) {
        var $K = kony.$kwebfw$, $KD = $K.dom,skinInfo;

        if(selectedCell) {
            skinInfo= _getSkinRelatedSkinInfoByGridCell(selectedCell)
            $KD.removeCls(selectedCell, skinInfo.selectedValue);
            $KD.addCls(selectedCell, skinInfo.normalValue);
            $KD.removeAttr(selectedCell, 'aria-selected');
        }
    };
