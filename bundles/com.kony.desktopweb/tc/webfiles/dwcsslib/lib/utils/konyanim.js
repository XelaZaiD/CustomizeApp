    ...
    var animator_animate = function Animator$animate(widget, config, callback, animType, animateHeightOnly) {
        ...
        if(arguments.length === 1) {
            ...
            if($KU.is(config, 'object')) {
                ...
                if([kony.anim.DIRECTION_ALTERNATE].indexOf(config.direction) != -1) {
                ...
                if([kony.anim.FILL_MODE_BACKWARDS, kony.anim.FILL_MODE_BOTH, kony.anim.FILL_MODE_FORWARDS].indexOf(config.fillMode) != -1) {
